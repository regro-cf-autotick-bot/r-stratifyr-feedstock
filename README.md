...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-stratifyr-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-stratifyr-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-stratifyr
# for installing globally
pixi global install r-stratifyr
```
...
It is possible to list all of the versions of `r-stratifyr` available on your platform:
...
```
pixi search r-stratifyr --channel conda-forge
```
